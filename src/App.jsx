...
export default function ChessClub() {
  ...
  useEffect(() => {
    ...
    setDoc(CLUB_DOC, { players, matches, results, activity, seasons, currentSeasonName, announcements, tiebreakers, updatedAt: Date.now() }).catch((err) => {
      console.error("Firestore save error:", err);
      setDbError(err.message);
    });
  }, [players, matches, results, activity, seasons, currentSeasonName, announcements, tiebreakers, dbLoaded]);
